...
\begin{itemize}
    ...
    % \item \textbf{Scaled experimentation by training 1M+ ML/RL models}, contributing to the \$35,000+ daily profit increase per asset.
...
{\customcventry{Toronto, Canada}{Fronix (\href{https://fronix.net/}{Website}) - Previously IntractAI \textbf{(Leadership)}}{Technical Co-founder}{August 2023 - Present (1 year and 6 months)}{}{}
}
% Co-founded a startup to build a specialized reasoning models for coding through continual post-training of LLMs with RL:
...
\begin{itemize}
    ...
    % \item \textbf{Post-trained LLMs with RL (PPO) and rejection sampling}, \textbf{improving reasoning} by 12\% on internal codebase.
